...
use Neko\Database\Connectors\ConnectionFactoryInterface;
...
class ConnectionResolver implements ConnectionResolverInterface
{
     ...
     *
     * Can be an instance of \Neko\Database\Connection or a valid config array, if a connection factory has been set
     *
     * @param  string $name
