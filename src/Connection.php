...
class Connection
{
    ...
    public function __construct($adapter, array $adapterConfig, $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\Neko\\Database\\EventHandler');
    ...
    {
        class_alias('Neko\\Database\\AliasFacade', $alias);
        $builder = $this->container->build('\\Neko\\Database\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\Neko\\Database\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
    ...
    protected function connect()
    {
        ...
        $adapter = '\\Neko\\Database\\ConnectionAdapters\\' . ucfirst(strtolower($this->adapter));
