<?php namespace Neko\Database\Query;
...
class Builder
{
     ...
     *
     * @var \Neko\Database\Query\Grammars\Grammar
     */
    protected $grammar;
     ...
     * @return \Neko\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\Neko\Database\Query\Builder|string $query
     * @param  string $as
     * @return \Neko\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Neko\Database\Query\Builder|static $query
     * @param  string $boolean
     * @return $this
     */
     ...
     *
     * @param  \Neko\Database\Query\Builder|\Closure $query
     * @param  bool $all
     * @return \Neko\Database\Query\Builder|static
     */
     ...
     *
     * @return \Neko\Database\Query\Builder
     */
    ...
    private function prepareInsertSelect($select)
    {
        ...
        {
            throw new \Exception("Argument 1 must be a closure or an instance of Neko\Database\\Query\\Builder");
        }
     ...
     *
     * @param  mixed $value
     * @return \Neko\Database\Query\Expression
     */
     ...
     *
     * @return \Neko\Database\ConnectionInterface
     */
     ...
     *
     * @return \Neko\Database\Query\Grammars\Grammar
     */
