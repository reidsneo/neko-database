<?php namespace Neko\Database\Query\Grammars;

use Neko\Database\Query\Builder;
use Neko\Database\Query\Expression;
...
class Grammar
{
     ...
     *
     * @param  \Neko\Database\Query\Expression $expression
     * @return string
     */
     ...
     *
     * @param  \Neko\Database\Query\Builder
     * @return string
     */
