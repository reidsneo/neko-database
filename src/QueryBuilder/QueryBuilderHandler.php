<?php namespace Neko\Database\QueryBuilder;

use PDO;
use Neko\Database\Connection;
use Neko\Database\Exception;
...
class QueryBuilderHandler
{
    ...
    /**
     * @var \Neko\Database\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    /**
     * @param null|\Neko\Database\Connection $connection
     *
     * @param int $fetchMode
     * @throws Exception
     */
    public function __construct(Connection $connection = null, $fetchMode = PDO::FETCH_OBJ)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\Neko\Database\\QueryBuilder\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function getQuery($type = 'select', $dataToBePassed = array())
    {
        ...
        return $this->container->build(
            '\\Neko\Database\\QueryBuilder\\QueryObject',
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\Neko\Database\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build('\\Neko\Database\\QueryBuilder\\Transaction', array($this->connection));
    ...
    {
        return $this->container->build('\\Neko\Database\\QueryBuilder\\Raw', array($value, $bindings));
    }
